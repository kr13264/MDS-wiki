...
| 항목 | 값 |
|------|------|
| 최대 폭 (max-width) | 1024px |
| 여백 (padding) | 상하 50px / 좌우 40px |
| 컴포넌트 제목 | 40px (Figma 플러그인 가이드 생성 시에는 64px 유지) |
| 소제목 (Measurement, Property 등) | 24px |
| 이미지 크기 | Figma scale=2 export → 원본 크기(1x)로 표시 (PNG 헤더에서 크기 추출) |
